...
from bang_tunes import (
    db_add_track, db_get_all_tracks, 
    db_update_track_metadata
)
...
def test_db_get_all_tracks():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Add test tracks
        db_add_track(conn, "test1", "Test Song 1", "Test Artist 1", "Test Album 1", "/path/to/song1.mp3")
        db_add_track(conn, "test2", "Test Song 2", "Test Artist 2", "Test Album 2", "/path/to/song2.mp3")
...
def test_db_update_track_metadata():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Add test track
        db_add_track(conn, "test1", "Old Title", "Old Artist", "Old Album", "/path/to/song1.mp3")
        ...
        # Update metadata
        success = db_update_track_metadata(conn, track_id, "New Title", "New Artist", "New Album")
        assert success
...
def test_db_update_nonexistent_track():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        success = db_update_track_metadata(conn, 999, "New Title", "New Artist", "New Album")
        assert not success
...
def test_metadata_editor_search_functionality():
    ...
    tracks = [
        ...
        {"id": 4, "title": "Another Brick in the Wall", "artist": "Pink Floyd", "album": "The Wall"},
    ]
